...
namespace DCRTasksTool
{
    public partial class TaskList : Form
    {
        ...
        private void buttonExecute_Click(object sender, EventArgs e)
        {
            ...
            string selectItemText = listView1.SelectedItems[0].SubItems[1].Text;
        ...
        private void LoadEvent(List<Events> lst)
        {
            ...
            foreach (Events item in lst.OrderByDescending(o => o.IsIncluded).ThenBy(o => o.IsPending).ThenBy(o => o.IsEnabled).ThenBy(o => o.IsExecuted))
            {
        ...
        private void buttonRefresh_Click(object sender, EventArgs e)
        {
            ...
            LoadEvent(FunctionalityFromRepository.GetLatestEvents(GraphID, SimID));
        }
